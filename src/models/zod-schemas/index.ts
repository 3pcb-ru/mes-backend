...
import { notifications } from '@/models/schema/notifications.schema';
...
export const notificationInsertSchema = createInsertSchema(notifications, standardTimestampInputOverrides);
export const notificationSelectSchema = createSelectSchema(notifications, standardTimestampPreprocessOverrides);
...
export type NotificationSelectOutput = z.infer<typeof notificationSelectSchema>;
