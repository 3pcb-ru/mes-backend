...
export class EventLoopHealthIndicator {
     ...
     */
    async isHealthy(key: string, options: { maxLag?: number; warningThreshold?: number } = {}): Promise<HealthIndicatorResult> {
        ...
        const data = {
            ...
            maxLag,
            warningThreshold,
            state: isHealthy ? (isWarning ? 'warning' : 'healthy') : 'critical',
