...
Commercial licensing helps sustain continued development and ensures
the project can evolve into a stable, production-ready platform.
...
You will receive guidance on available licensing options.
...
No commercial license is required for **non-commercial evaluation or internal learning**.

---

## Final Notes

This file is intended to clarify commercial boundaries and does not
replace the LICENSE file.

For full legal terms, always refer to the [LICENSE](./LICENSE).
